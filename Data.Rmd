...
## Load and clean jump data (añadiendo peak_propulsive_force)
...
df <- df_jump %>%
  ...
  select(
    ...
    rsi,
    m_rsi,
    peak_propulsive_force,         # <— Asegúrate de incluirla
  ...
  filter(!is.na(date)) %>%
  tidyr::drop_na(peak_propulsive_force,
                 left_avg_propulsive_force,
                 right_avg_propulsive_force)

## Join con demographics
